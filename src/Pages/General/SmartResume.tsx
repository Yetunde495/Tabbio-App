...
const SmartResume: React.FC = () => {
  const [profileData] = useState<any | null>(mockProfileData);
    ...
    <section className="h-screen bg-[#F9FAFB]">
                ...
                <div className="mt-3 ">
                  ...
                  {showCompetencies && (
                    <div className="py-2 border-t border-stroke w-full flex gap-2 items-center flex-wrap">
                      ...
                      <Pill>Cloud Infrastructure</Pill> <Pill>Agile/Scrum</Pill>{" "}
                      <Pill>DevOps</Pill> <Pill>API Design</Pill>{" "}
                ...
                <div className="py-5 w-full flex justify-center items-center">
                  {profileData?.career_highlights.length > 3 && (
                    ...
                    >
                      ...
                      <span>
                        {!showAllCareer ? <IoIosArrowDown /> : <IoIosArrowUp />}
                      </span>
                    </button>
                  )}
                </div>
      ...
      <div className="fixed left-0 right-0 w-full bottom-0">
        <div className="w-full flex justify-between max-sm:text-xs text-sm items-center text-zinc-500 py-3.5 px-5 bg-[#FBFCFC] border border-[#F3F4F6]">
          ...
          <Link to={`/signup`} className="flex items-center gap-1 text-primary">
