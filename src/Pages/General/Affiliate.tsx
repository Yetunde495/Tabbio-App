  ...
  return (
    <Layout>
      <section className="bg-gradient-to-b from-white to-[#EFF6FF]">
        <div className="bg-[linear-gradient(134.95deg,_#5272EA_6.55%,_#394FC0_93.38%)] w-full py-2 2xl:px-[12rem] md:px-[4rem] px-4">
        ...
        <section className="p-8  md:pt-6 md:pb-14 text grid grid-cols-1 gap-12 xl:max-w-7xl 2xl:max-w-full 2xl:px-[12rem] w-full mx-auto">
          ...
          <div className="grid lg:grid-cols-3 mb-6 md:grid-cols-2 grid-cols-1 gap-4 justify-center items-center w-full transition-all mx-auto duration-500 ease xs:gap-y-8 gap-x-6">
            <div className="shadow-sm hover:bg-gradient-to-br from-[#5272EA] to-[#394FC0] group h-full bg-white  rounded-xl w-full px-4 py-6 space-y-3 flex-col flex justify-center">
              <div className="flex items-center gap-2 group-hover:text-white px-2">
                <LuBuilding2 size={20} className="" />
                <h1 className="text-zinc-800 group-hover:text-white font-semibold text-lg">
                  Recruiters & Agencies
                </h1>
              </div>

              <p className="text-zinc-500 text-[13px] text-center group-hover:text-[#eff6ff]">
                Double-dip: Earn from both placing candidates AND their Tabbio
                subscriptions
              </p>
            </div>
            <div className="shadow-sm hover:bg-gradient-to-br from-[#5272EA] to-[#394FC0] group h-full bg-white  rounded-xl w-full px-4 py-6 space-y-3 flex-col flex justify-center">
              <div className="flex items-center group-hover:text-white gap-2 px-2">
                <LuUsers size={20} />
                <h1 className="text-zinc-800 group-hover:text-white font-semibold text-lg">
                  Career Influencers
                </h1>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
              <div className="flex flex-col gap-6">
                ...
                <p className="text-zinc-600">
                  <span className="bg-gradient-to-b from-[#5272EA] to-[#394FC0] text-transparent text-2xl font-bold bg-clip-text inline-block">
                    5
                  </span>{" "}
                  referrals/month
                </p>
              ...
              <div>
                <div className="bg-gradient-to-r from-[#EFF6FF] to-[#DBEAFE] flex flex-col justify-center rounded-xl px-8 py-5 mb-4">
                  ...
                  <h6 className="font-semibold md:text-2xl text-xl bg-gradient-to-br from-[20px] w-[60px] from-[#5272EA] to-[#394FC0] text-transparent bg-clip-text inline-block">
                    $880
                  </h6>
                </div>
                <div className="bg-gradient-to-r from-[#FAF5FF] to-[#F3E8FF] flex flex-col justify-center rounded-xl px-8 py-5">
                  ...
                  <h6 className="font-semibold md:text-2xl text-xl bg-gradient-to-r from-[#5272EA] to-[#394FC0] from-[20px] w-[100px] text-transparent bg-clip-text  inline-block">
                    $10, 560
                  </h6>
                </div>
              </div>
